...
<Steps>
  <Step title="Create your account">
    ...
    <Tabs>
      <Tab title="Web App">
        1. Navigate to [app.ecoevents.com/signup](https://app.ecoevents.com/signup)
...
<Tip>
  Check out our [GitHub repository](https://github.com/ecoevents/platform) for open-source components and contribution guidelines.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="comments"
    href="https://community.ecoevents.com"
  >
    Join discussions with other event organizers
  </Card>
